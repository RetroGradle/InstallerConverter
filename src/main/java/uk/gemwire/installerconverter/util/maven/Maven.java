...
public abstract class Maven {
    ...
    public static final String FORGE = "https://maven.minecraftforge.net/";
    public static final String FORGE_OLD = "https://files.minecraftforge.net/maven/";
    public static final String ATERANIMAVIS = "https://ateranimavis.github.io/maven/";
